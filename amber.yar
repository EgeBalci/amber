...
rule Amber_Reflective_PE_Packer {
	...
	strings:
		...
		$s1 = "<Amber:27a01d4772038a3f83552908e0470604e773f8af>" wide
		$s2 = "Mingw-w64 runtime failure:" wide 

	condition:
		($s and $s1 and $s2) and filesize > 12KB and (pe.number_of_sections == 16 or pe.number_of_sections == 15 or pe.number_of_sections == 7)
